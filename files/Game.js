...
class Game {
    ...
    //añadido para el ejercicio (paso 1)
    ...
    removeOpponent () {
      /*  if (this.opponent) {
        ...
        if(this.score>SHOT_BEFORE_BOSS){ //CANTIDAD DE pegadas antes de que se cambie a jefe
    ...
    endGame () {
       /* this.ended = true;
        ...
        this.ended = true;
        let gameOver;
        if (this.player.getLives()>0){ //Añadido para el ejercicio (paso 8)
    ...
    // Añadisos para el ejercicio
    incrementaScore(){ // paso 2
        this.score++;
    }
